...
- __Molecular dynamics__
  - long range force cutoff, Ewald: [link](https://en.wikibooks.org/wiki/Molecular_Simulation/Treatment_of_Long_Range_Forces https://upload.wikimedia.org/wikipedia/commons/6/61/Lj-cutoff-scheme.svg)
